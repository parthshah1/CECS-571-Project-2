 ...
 * Source Class: DefaultPSSite <br>
 */
public class DefaultPSSite extends WrappedIndividualImpl implements PSSite {

    public DefaultPSSite(CodeGenerationInference inference, IRI iri) {
        super(inference, iri);
    }
