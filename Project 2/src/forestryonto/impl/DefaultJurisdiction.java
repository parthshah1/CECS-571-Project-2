 ...
 * Source Class: DefaultJurisdiction <br>
 *  */
public class DefaultJurisdiction extends WrappedIndividualImpl implements Jurisdiction {

    public DefaultJurisdiction(CodeGenerationInference inference, IRI iri) {
        super(inference, iri);
    }
